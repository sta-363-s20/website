...
The data contain 256 columns labelled "x.1" - "x.256" and a response column labelled "g".
...
5. Using the `lda()` function from the **MASS** package, perform a linear discriminant analysis predicting `g`, the outcome variable for the phoneme, from the rest of the variables using the `train` data.
